...
<head>
    ...
    <style>
        *{
        ...
        #create_folder,.btn.btn-success {
            
            color: white;
            transition: all 60ms;
        }
        #create_folder, .btn.btn-success:hover {
            border-radius: 6%;
...
<body>
    <h1 class="prueba text-center">Folder List <img src="bloc.png" width="100px"> </h1>  <br>

    <div class="text-center">
    <button type="button" name="create_folder" id="create_folder" class="btn">Nueva Carpeta</button><br><br>
    </div>  
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Indica el nombre de la carpeta</p>
                <input type="text" name="folder_name" id="folder_name" class="form-control"> 
                <input type="hidden" name="action" id="action">
                <input type="hidden" name="old_name" id="old_name"><br>
                <input type="button" name="folder_button" id="folder_button" class="btn btn-success" value="Crear">
            </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="button" name="file_button" id="file_button" class="btn btn-success" value="Create_file">
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
            </div>
